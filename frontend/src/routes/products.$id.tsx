        ...
        <div className="flex flex-col">
          ...
          <div className="mt-6 flex gap-3">
            ...
            <Link to="/cart" className="flex-1">
              <Button size="lg" variant="outline" className="w-full rounded-full">Buy now</Button>
            </Link>
          </div>
          ...
          <div className="mt-8 grid gap-3 rounded-2xl border border-border/60 bg-card p-5">
            ...
            <div className="flex items-center gap-3 text-sm"><Truck className="h-5 w-5 text-primary" /> Free same-day delivery over $25</div>
            <div className="flex items-center gap-3 text-sm"><Leaf className="h-5 w-5 text-primary" /> Earn 5 health points on this item</div>
          </div>
        </div>
      </div>
    </div>
